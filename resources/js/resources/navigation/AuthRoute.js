                ...
                {auth && (
                    <>
                        ...
                        <Routes>
                            ...
                            />
                            <Route
                                path={`${basePath}/categories/add`}
                                element={<Pages.AddCategory />}
                            />
                            <Route
                                path={`${basePath}/categories/edit/:categoryId`}
                            ...
                            />
                            <Route
                                path={`${basePath}/books/add`}
                                element={<Pages.AddBook />}
                            />
                            <Route
                                path={`${basePath}/books/edit/:bookId`}
                                element={<Pages.EditBook />}
                            />
                            <Route
                                path={`${basePath}/books`}
                                element={<Pages.Books />}
